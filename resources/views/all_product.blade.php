						...
						@foreach($all_product_info as $v_product)
						  <tbody>
							<tr>
								...
								<td class="center">
								@if($v_product->product_status==1)
								<a class="btn btn-danger" href="{{URL::to('admin/unactive-product'.$v_product->id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
									</a>
								@else
								    <a class="btn btn-success" href="{{URL::to('admin/active-product'.$v_product->id)}}">
										<i class="halflings-icon white thumbs-up"></i>  
									</a>
								@endif
									<a class="btn btn-info" href="{{URL::to('admin/edit-product'.$v_product->id)}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="{{URL::to('admin/delete-product'.$v_product->id)}}">
