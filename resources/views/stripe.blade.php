...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form  action="{{url('payment')}}"  data-cc-on-file="false" data-stripe-publishable-key="STRIPE_KEY" name="frmStripe" id="frmstripe" method="post">
                {{ csrf_field() }}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-control total btn btn-primary">
                            Total: <span class="amount">$10</span>
                        </div>
                    </div>
                </div>
                <div class="row">
