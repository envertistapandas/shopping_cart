                                ...
                                <div class="single-products">
                                        ...
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2>Rs-{{$v_published_product->product_price}}</h2>
                                                <p>{{$v_published_product->product_name}}</p>
                                                <a href="{{URL::to('/add-to-product'.$v_published_product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                        </div>
                                </div>
                                <div class="choose">
